...
outputPT=experiments/pretrain/merged_s1_s2-gate_mixer_hpre24_loss1
# ==============================================================================
...
# *****************************************************************************
output_sft=experiments/241122-SFT_${sft_data}-merged_s1_s2/llama31_siglip_convnext_384-gate_mixer_hpre24_loss1
mkdir -p $output_sft
...
# deepspeed llava_align/train/train_mem.py \
#     --deepspeed scripts/zero2_llava_next.json \
#     --model_name_or_path playground/model/Meta-Llama-3.1-8B-Instruct \
#     --llm_backbone llama_3_1 \
#     --llm_pad_token pad \
#     --version ${PROMPT_VERSION} \
#     --data_path playground/data/pretrain/${it_file} \
#     --image_folder playground/data/images \
#     --vision_tower playground/model/google/siglip-so400m-patch14-384 \
#     --mm_projector_type ${mm_projector_type} \
#     --vision_tower_mix $vision_tower_mix \
#     --image_size_mix $image_size_mix \
#     --num_register_tokens $num_register_tokens \
