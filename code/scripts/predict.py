...
from vilamr.conversation import conv_templates, SeparatorStyle
from vilamr.model.builder import load_pretrained_model
from vilamr.utils import disable_torch_init
from vilamr.mm_utils import tokenizer_image_token
...
weights = [
    {
        "dest": "liuhaotian/vilamr-v1.5-13b",
        # git commit hash from huggingface
        "src": "vilamr-v1.5-13b/006818fc465ebda4c003c0998674d9141d8d95f8",
        "files": [
            "config.json",
...
class Predictor(BasePredictor):
    def setup(self) -> None:
        ...
        self.tokenizer, self.model, self.image_processor, self.context_len = load_pretrained_model("liuhaotian/vilamr-v1.5-13b", model_name="vilamr-v1.5-13b", model_base=None, load_8bit=False, load_4bit=False)
